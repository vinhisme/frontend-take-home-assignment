...
export const CreateTodoForm = () => {
  ...
  return (
    <form className="group flex items-center justify-between rounded-12 border border-gray-200 py-2 pr-4 focus-within:border-gray-400" onSubmit={handleSubmit}>
      ...
      <button
        ...
        className="bg-gray-700 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full"
      >
        Add
      </button>
    </form>
